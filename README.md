...
[![Generic badge](https://img.shields.io/badge/medlem-1.1.11-blue.svg)](https://github.com/navikt/aap-avro/packages/1262528}?version=1.1.11)
[![Generic badge](https://img.shields.io/badge/sokere-0.0.2-blue.svg)](https://github.com/navikt/aap-avro/packages/1271717}?version=0.0.2)
[![Generic badge](https://img.shields.io/badge/manuell-0.0.9-blue.svg)](https://github.com/navikt/aap-avro/packages/1271715}?version=0.0.9)
[![Generic badge](https://img.shields.io/badge/inntekter-0.0.8-blue.svg)](https://github.com/navikt/aap-avro/packages/1271858}?version=0.0.8)
...
```kotlin
implementation("no.nav.aap.avro:medlem:1.1.11")
```
...
```kotlin
implementation("no.nav.aap.avro:sokere:0.0.2")
```
...
```kotlin
implementation("no.nav.aap.avro:manuell:0.0.9")
```
...
```kotlin
implementation("no.nav.aap.avro:inntekter:0.0.8")
```
