...
[![Generic badge](https://img.shields.io/badge/inntekter-0.0.7-blue.svg)](https://github.com/navikt/aap-avro/packages/1271858}?version=0.0.7)
...
```kotlin
implementation("no.nav.aap.avro:inntekter:0.0.7")
```
