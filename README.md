...
[![Generic badge](https://img.shields.io/badge/medlem-1.2.0-blue.svg)](https://github.com/navikt/aap-avro/packages/1262528}?version=1.2.0)
...
```kotlin
implementation("no.nav.aap.avro:medlem:1.2.0")
```
