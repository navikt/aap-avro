...
[![Generic badge](https://img.shields.io/badge/sokere-3.0.1-blue.svg)](https://github.com/navikt/aap-avro/packages/1271717}?version=3.0.1)
...
```kotlin
implementation("no.nav.aap.avro:sokere:3.0.1")
```
